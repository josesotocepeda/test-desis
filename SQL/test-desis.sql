...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2023 at 06:58 PM
...
CREATE TABLE `regiones` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `ordinal_symbol` varchar(255) DEFAULT NULL,
...
INSERT INTO `regiones` (`id`, `name`, `ordinal_symbol`, `orden`) VALUES
...
INSERT INTO `votaciones` (`id`, `nombre`, `alias`, `rut`, `email`, `region`, `comuna`, `candidato`, `como`) VALUES
(1, 'asdasd', 'asd123', '13023865-3', 'kote@gmail.com', 4, 23, 4, 'tv,redes_sociales'),
(2, 'Patricia Cepeda', 'pat678', '8480946-2', 'patisabel.cepeda@gmail.com', 6, 79, 2, 'web,tv,redes_sociales,amigo'),
(3, 'Patricia Andrea Soto Cepeda', 'pat777', '14000470-7', 'andrea.soto@gmail.com', 5, 33, 1, 'web,redes_sociales'),
(4, 'Macarena De Las Mercedes Parrau Gallardo', 'mdm444', '14232983-2', 'macarena@hotmail.com', 1, 4, 3, 'tv,redes_sociales'),
(5, 'Aladino Segundo Espinoza Saavedra', 'ala556', '15371275-1', 'aladino@deseos.cl', 7, 86, 1, 'web,redes_sociales');
